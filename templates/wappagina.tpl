...
<div  class="wtitulo" {if $displayImagemTitulo == '1'}style="background-image: url('{$relativePATH}imagens/duda_logo.gif');background-repeat: no-repeat; background-position: top right;{/if}">
