<form name="salvarTema" id="salvarTema" action="javascript: salvarTema();">
    ...
    <div class="item"><input type="text" class="FormExtra" size=30 id="nomeTema" placeholder="{$LANG.hp_estilos_Placeholder_nomeEstilo}" tabindex="1" /></div>
    <div class="itemLateral">{$LANG.hp_estilos_comentarioEstilo}</div>
    <div class="item"><input type="text" class="FormExtra" size=30 id="comentarioTema" placeholder="{$LANG.hp_estilos_Placeholder_comentarioEstilo}" tabindex="2" /></div>
