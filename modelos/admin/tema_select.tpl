...
<div class="contentSelecao">
    ...
    <div class="contornoSelecao">
        <div class="boxSelecao" id="boxSelecao">
            ...
            <input class="boxRadio noselect" type="radio"  id="{$temas[t].id}" name="selectTema" value="{$temas[t].id}" onClick="document.getElementById('id').value = this.value;" style="user-select: none;"/>
    ...
    <div class="interior" style="text-align: center; padding-top: 4pt; margin: 1.5rem;">
        <input type="submit" class="submitEspacado" value="{$LANG.confirmar}" onclick="window.location = '{$includePATH}admin/tema_edit.php?mode=edTema&id=' + document.getElementById('id').value";/> 
